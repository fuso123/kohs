# Script MAT MOTO V6-Websocket
 Welcome MAT MOTO😊

 <h2 align="center">AutoScript VPN By BASIKAL <img src="https://img.shields.io/badge/Version-6.0-blue.svg"></h2>
...
## ♦️INSTALLATION SCRIPT ( Recommended Debian 10 11 12)♦️
  ...
  ```html
  apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/fuso123/kohs/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
